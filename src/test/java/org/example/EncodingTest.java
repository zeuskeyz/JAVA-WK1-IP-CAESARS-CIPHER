...
class EncodingTest {
    ...
    void encode() {
        ...
        //TESTS TO SEE IF THE USER INPUT IS ENCODED USING THE VALUE OF THE KEY PROVIDED
        assertEquals("QEB NRFZH YOLTK CLU GRJMP LSBO QEB IXWV ALD", Encoding.encode("THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG", 23));

        //TESTS TO SEE IF THERE IS AN ERROR THROWN IF THE KEY IS GREATER THAN OR LESS THAN THE LIMIT
